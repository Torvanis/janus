...
class ChartTest(unittest.TestCase):
    ...
    def test_image_digest_and_tag(self):
        ...
        self.assertEqual(image, "ghcr.io/torvanis/janus@sha256:b789411252a3bd5724c77d15a02c7c388178ba6a3e95c5916367d3a682e094b6")
        image = deployment(self.render({"image": {"digest": "", "tag": "2026.9.1"}}))["spec"]["template"]["spec"]["containers"][0]["image"]
        self.assertEqual(image, "ghcr.io/torvanis/janus:2026.9.1")
    ...
    def test_package_roundtrip(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            package = Path(temp) / "janus-0.1.0.tgz"
